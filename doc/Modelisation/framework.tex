...
\subsection{Environnement & IA}
\begin{figure}[!h]\centering
   \includegraphics[scale=0.8]{images/uc_main.png}
   \caption{\label{uc_main} Cas d'utilisation généraux}
\end{figure}
\subsection{Ressources}
\begin{figure}[!h]\centering
   \includegraphics[scale=0.8]{images/uc_ressources.png}
   \caption{\label{uc_main} Cas d'utilisation liés aux ressources}
\end{figure}
\subsection{Framework}
\begin{figure}[!h]\centering
   \includegraphics[scale=0.8]{images/uc_framework.png}
